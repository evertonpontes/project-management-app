  ...
  return (
    <div className="flex flex-col gap-2">
      <div
        ...
        className={cn(
          "group-upc bg-muted border-border relative flex aspect-square size-54! items-center justify-center overflow-hidden rounded-md border-2 border-dashed p-2 transition-colors duration-150",
          draggingOver && "bg-primary/5 border-primary/80",
      ...
      >
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          {file && (
            <button
              type="button"
              className="bg-background/40 text-foreground/30 hover:bg-background/60 absolute top-1 right-1 z-1 flex size-8 items-center justify-center overflow-hidden rounded-full transition-colors duration-150"
              title="Remove image"
